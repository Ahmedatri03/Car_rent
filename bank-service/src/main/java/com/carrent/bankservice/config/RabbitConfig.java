package com.carrent.bankservice.config;
...
public class RabbitConfig {
    ...
    @Bean
    public Queue creditCheckRequestQueue() {
        return new Queue(CREDIT_CHECK_REQUEST_QUEUE, true);
    }
    ...
    @Bean
    public Binding creditCheckRequestBinding(Queue creditCheckRequestQueue, DirectExchange creditExchange) {
        return BindingBuilder.bind(creditCheckRequestQueue).to(creditExchange).with(CREDIT_CHECK_REQUEST_KEY);
    }
